...
if (isset($_SESSION['user'], $_GET['delete'])) {
    ...
    $filePath = "$uploadBase/$username/$fileToDelete";
    ...
    <?php else: ?>
        <div class="grid">
            <?php foreach ($files as $file): 
                ...
                $fileUrl = "uploads/" . urlencode($_SESSION['user']) . "/" . urlencode($file);
            ?>
                <div class="tile">
                    <div class="preview">
                        <?php if ($isImage): ?>
                    ...
                    <div class="actions">
                        ...
                        <a href="?delete=<?= urlencode($file) ?>" onclick="return confirm('Delete this file?');" style="color:red;">Delete</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
